...
export const mortgageCalculator = ai.defineTool(
  {
    ...
    inputSchema: z.object({
      ...
      interestRate: z.number().describe('Amount you will pay each year to borrow the money for your loan, expressed as a percentage.'),
      zipCode: z.string().describe('The zip code'),
    }),
    outputSchema: z.object({
      monthlyPayment: z.number().describe("The amount of money that you will have to pay every month to finance a home with the provided values."),
